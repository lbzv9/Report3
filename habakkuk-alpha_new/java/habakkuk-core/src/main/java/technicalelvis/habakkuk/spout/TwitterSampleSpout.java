...
//	static Logger LOG = Logger.getLogger(TwitterSampleSpout.class);
    ...
    public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
        ...
        String[] keywordsArray = {"Annabelle", "movie"};
        filtre.track(keywordsArray);
        _twitterStream.filter(filtre);
    ...
    public void nextTuple() {
        ...
        /*	Map<String, String> data = new HashMap<String, String>();
        	...
        	for(MediaEntity mediaEntity:ret.getMediaEntities())
        	{
        		
        		_collector.emit(new Values(mediaEntity.getMediaURL()))	;
        	}
