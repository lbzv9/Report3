...
import technicalelvis.habakkuk.bolt.ImageCollectBolt;
import technicalelvis.habakkuk.bolt.ImageNegativeBolt;
...
public class MainTopology {
	...
	final static String ImageCollectBolt = "ImageCollectBolt";
	final static String ImageNegativeBolt = "ImageNegativeBolt";
   ...
   /*!!     builder.setBolt(MATCHBOLT, new ScriptureFilterBolt(), numBibleFilterBolts)
        ...
        builder.setBolt(ImageCollectBolt, new ImageCollectBolt(), 1)
		.shuffleGrouping(TWITTERSPOUT);
        
        builder.setBolt(ImageNegativeBolt, new ImageNegativeBolt(), 1)
		.shuffleGrouping(ImageCollectBolt);
